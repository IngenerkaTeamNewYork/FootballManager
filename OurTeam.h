...
std::vector<RoundObj> Bayern = {
        RoundObj({700, 5}  , 20, "Neuer", sf::Color::Blue    ,sf::Color::Red),
        RoundObj({700, 50}, 20, "Alaba", sf::Color::Blue    ,sf::Color::Red),
        RoundObj({700, 100}  , 20, "Boateng", sf::Color::Blue  ,sf::Color::Red),
        RoundObj({750, 5}  , 20, "Hummels", sf::Color::Blue  ,sf::Color::Red),
        RoundObj({750, 50}  , 20, "Kimmich", sf::Color::Blue  ,sf::Color::Red),
        RoundObj({750, 100}  , 20, "Vidal", sf::Color::Blue    ,sf::Color::Red),
        RoundObj({775, 5}  , 20, "Thiago", sf::Color::Blue   ,sf::Color::Red),
        RoundObj({775, 50}  , 20, "Ribery", sf::Color::Blue   ,sf::Color::Red),
        RoundObj({775, 100}  , 20, "Rodriguez", sf::Color::Blue,sf::Color::Red),
        RoundObj({775, 125}  , 20, "Robben", sf::Color::Blue   ,sf::Color::Red),
        RoundObj({775, 125}  , 20, "Lewa", sf::Color::Blue     ,sf::Color::Red)
};
